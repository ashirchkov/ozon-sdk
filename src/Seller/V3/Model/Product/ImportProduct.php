...
readonly class ImportProduct extends AbstractModel
{
    /**
     ...
     * @param ProductAttribute[] $attributes Массив с характеристиками товара
     * @param ImportProductComplexAttributes|null $complex_attributes Массив характеристик, у которых есть вложенные атрибуты
     ...
     * @param ImportProductPdfFile[]|null $pdf_list Список PDF-файлов
    ...
    public function __construct(
        ...
        public ?ImportProductComplexAttributes $complex_attributes = null,
